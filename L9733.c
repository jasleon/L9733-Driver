...
typedef enum {
  L9773_CMD_TYPE_OUTPUT,
  L9773_CMD_TYPE_DIAG_MODE,
  L9773_CMD_TYPE_PROTECT,
} l9733_cmd_type_t;
...
static fms_rslt_t l9733_set_cmd(l9733_t *obj, l9733_cmd_type_t cmd) {
  ...
  switch (cmd) {
    case L9773_CMD_TYPE_OUTPUT:
      msg |= L9773_CMD_WM_OUTPUT;
      msg |= obj->output;
      break;
    case L9773_CMD_TYPE_DIAG_MODE:
      msg |= L9773_CMD_WM_DIAG;
      msg |= obj->diag_mode;
      break;
    case L9773_CMD_TYPE_PROTECT:
...
fms_rslt_t l9733_set_output(l9733_t *obj) {
  return l9733_set_cmd(obj, L9773_CMD_TYPE_OUTPUT);
}

fms_rslt_t l9733_set_diag_mode(l9733_t *obj) {
  return l9733_set_cmd(obj, L9773_CMD_TYPE_DIAG_MODE);
}

fms_rslt_t l9733_set_protection(l9733_t *obj) {
  return l9733_set_cmd(obj, L9773_CMD_TYPE_PROTECT);
}
